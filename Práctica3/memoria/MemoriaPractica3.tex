...
AGE(clases, conjunto, knn) |\textbf{Empezar}|:
   ...
   while num_evaluaciones < 15000:
      ...
      tasa1 = CalcularTasa(conjunto, hijo1, knn)
      tasa2 = CalcularTasa(conjunto, hijo2, knn)
      # Guardamos los hijos en la poblaci|\textit{ó}|n si son mejores
      # que los peores de la poblaci|\textit{ó}|n.
      if tasa1 > tasa2:
