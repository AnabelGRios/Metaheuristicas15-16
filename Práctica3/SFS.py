...
# más prometedora.
def caracteristicaMasPrometedora(clases, mascara, conjunto, knn):
	...
	return mejor_tasa, mejor_pos

# Algoritmo greedy SFS
def SFS(clases, conjunto, knn):
	...
	while(mejora):
		...
		nueva_tasa, mejor_pos = caracteristicaMasPrometedora(clases, caracteristicas, conjunto, knn)
