...
def AGG1(clases, conjunto, knn):
	...
	while(num_evaluaciones < 15000):
		...
		# Realizamos búsqueda local si han pasado 10 iteraciones sobre toda la población
		if num_generaciones == 10:
			num_generaciones = 0
			for l in range(10):
				poblacion[l][0], nueva_tasa, iter_BL = busquedaLocal(clases, conjunto, poblacion[l][0], knn)
				poblacion[l][1] = nueva_tasa
